...
const contents: ContentType[] = [
  {
    heading: (
      <>
        Revolutionising The{' '}
        <span className='text-[#B28AE4]'>Social Future</span> <br /> With
        BlinkVerse
      </>
    ),
    image: heroImage.src,
...
const Content = () => {
  return (
    <section
      className={
        monda.className +
        ' w-full h-full text-white bg-[#110F1FA3] relative flex flex-col justify-between overflow-hidden gap-5 sm:pt-[48px]'
      }
    >
...
const ContentItem = ({ heading, image, style }: ContentType) => {
  return (
    <div className='flex flex-col items-center gap-3'>
      ...
      <p className='text-center'>Create your own blinks with one click!</p>
